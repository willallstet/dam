...
- **Token format.** `pk_` + base64url-encoded 32 bytes of cryptographic randomness (Node stdlib; no hand-rolled encoder). SHA-256 at rest — argon2id solves low-entropy passwords; high-entropy random tokens don't need it.
