...
- [ADR-056 — API keys with scopes for headless CLI use](../adrs/056-api-keys-headless-auth.md) — the public port's bearer middleware dispatches by token prefix; JWTs and API keys share one auth slot
